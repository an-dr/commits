...
- [ ] **Honour a host-requested repository switch (~150 lines)** (verified) — Treat a lastActiveRepo that differs from the shown repository as an instruction to switch and refresh, so opening a repository from the menu loads it.

_Last updated: 2026-08-01T17:34:57.2582160Z_