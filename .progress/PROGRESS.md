...
- [x] **Spawn git without console windows (~80 lines)** (completed) — Set CREATE_NO_WINDOW on spawned Git processes so a windowed host does not flash a console for every command.

_Last updated: 2026-08-02T09:14:35.5675555Z_