...
export const svgIcons = {
  ...
  /**
   * Marks the branch HEAD is on. It is the only icon a ref label carries, so
   * it has to read as "you are here" at 14px rather than as decoration: a solid
   * triangle pointing into the name does that where a glyph would not.
   */
  currentBranch:
    '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16"><path fill-rule="evenodd" d="M5 3.5l6 4.5-6 4.5z"/></svg>',
  close:
