...
export function createLocalizedStrings(t: Translate): LocalizedStrings {
  return {
    ...
    changesUnstageFile: t("Unstage file"),
    changesDiscardFile: t("Discard changes"),
    changesDiscardConfirm: t("Discard the changes to {0}? This cannot be undone."),
    changesDiscardUntrackedConfirm: t("Delete the untracked file {0}? This cannot be undone."),
    changesUnableToStage: t("Unable to Stage File"),
    changesUnableToUnstage: t("Unable to Unstage File"),
    changesUnableToDiscard: t("Unable to Discard Changes"),
    changesUnstagedSection: t("Changes"),
    changesNothingToCommit: t("Nothing to commit"),
    changesStatusAdded: t("Added"),
    changesStatusDeleted: t("Deleted"),
    changesStatusModified: t("Modified"),
    changesStatusRenamed: t("Renamed"),
    changesStatusUntracked: t("Untracked"),
