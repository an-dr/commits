...
export function createLocalizedStrings(t: Translate): LocalizedStrings {
  return {
    ...
    changesMessagePlaceholder: t("Commit message"),
    changesAmend: t("Amend last commit"),
    changesCommit: t("Commit"),
    changesUnableToCommit: t("Unable to Commit"),
    ...
    unableToDeleteRemoteBranch: t("Unable to Delete Remote Branch"),
    unableToFetch: t("Unable to Fetch"),
    unableToMergeBranch: t("Unable to Merge Branch"),
    unableToMergeCommit: t("Unable to Merge Commit"),
    unableToPull: t("Unable to Pull"),
    unableToPush: t("Unable to Push"),
    unableToPushTag: t("Unable to Push Tag"),
    unableToRebase: t("Unable to Rebase"),
    unableToRunTool: t("Unable to Run Tool"),
    openIn: t("Open in {0}"),
    openInTitle: t("Open this repository in an external tool"),
    configureTools: t("Configure tools"),
    ...
    // Dropping a ref badge on a commit row
    dropMoveBranch: t("Move Branch {0} to {1}"),
    dropResetHead: t("Reset {0} to {1}"),
    dropRebase: t("Rebase {0} onto {1}"),
    dropMoveTag: t("Move Tag {0} to {1}"),
    dialogMoveBranchConfirm: t("Are you sure you want to move branch {0} to commit {1}?"),
    dialogYesMoveBranch: t("Yes, move branch"),
    dialogMoveTagTitle: t("Move tag {0} to commit {1}"),
    dialogMoveTagSubmit: t("Move Tag"),
    dialogRebaseConfirm: t("Are you sure you want to rebase {0} onto commit {1}?"),
    dialogRebaseIgnoreDate: t("Ignore Date"),
    dialogYesRebase: t("Yes, rebase"),
